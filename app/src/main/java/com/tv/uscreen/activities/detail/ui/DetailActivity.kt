package com.tv.uscreen.activities.detail.ui
...
import com.tv.uscreen.activities.detail.viewModel.DetailViewModel
import com.tv.uscreen.activities.downloads.NetworkHelper.isWifiEnabled
...
import com.tv.uscreen.adapters.player.EpisodeTabAdapter
...
import com.tv.uscreen.beanModel.responseModels.detailPlayer.Data
...
import com.tv.uscreen.callbacks.commonCallbacks.NetworkChangeReceiver
import com.tv.uscreen.databinding.DetailScreenBinding
...
import com.tv.uscreen.fragments.player.ui.RelatedContentFragment
import com.tv.uscreen.fragments.player.ui.UserInteractionFragment
import com.tv.uscreen.networking.apistatus.APIStatus
import com.tv.uscreen.networking.responsehandler.ResponseModel
...
import com.tv.uscreen.utils.colorsJson.converter.ColorsHelper.strokeBgDrawable
...
//            if ("true".equalsIgnoreCase(videoItemBean.getComingSoon())) {
...
//                            GetPlansLayer.getInstance().getEntitlementStatus(preference, token,
//                                    (entitlementStatus, apiStatus) -> {
//                                        getBinding().pBar.setVisibility(View.GONE);
//                                        if (entitlementStatus && apiStatus) {
//                                            isAdShowingToUser = false;
//                                        }
//                                        if (videoDetails.getBrightcoveVideoId() != null && !videoDetails.getBrightcoveVideoId().equalsIgnoreCase("")) {
