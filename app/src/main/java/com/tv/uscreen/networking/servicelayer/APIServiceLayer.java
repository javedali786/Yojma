package com.tv.uscreen.networking.servicelayer;
...
import com.tv.uscreen.activities.watchList.model.VideoIdModel;
...
import com.tv.uscreen.beanModelV3.continueWatching.ContinueWatchingModel;
import com.tv.uscreen.beanModelV3.continueWatching.DataItem;
import com.tv.uscreen.beanModelV3.playListModelV2.EnveuCommonResponse;
import com.tv.uscreen.beanModelV3.searchV2.Data;
import com.tv.uscreen.beanModelV3.searchV2.ResponseSearch;
import com.tv.uscreen.beanModelV3.uiConnectorModelV2.EnveuVideoItemBean;
import com.tv.uscreen.beanModelV3.videoDetailsV2.EnveuVideoDetailsBean;
import com.tv.uscreen.bean_model_v1_0.listAll.ListAllContent;
import com.tv.uscreen.bean_model_v1_0.videoDetailBean.EnvVideoDetailsBean;
import com.tv.uscreen.callbacks.RequestOffferCallBack.RequestOfferCallBack;
...
import com.tv.uscreen.callbacks.likelistCallback.ApiLikeList;
...
import com.tv.uscreen.utils.config.ImageLayer;
import com.tv.uscreen.utils.config.LanguageLayer;
...
public class APIServiceLayer {
    ...
    public void getIsLikeGOI(String token ,int pageNumber, int size, ApiLikeList listener) {
        ...
        if (enveuSubscriptionEndPoint!=null) {
            enveuSubscriptionEndPoint.getIsLikeGOI(pageNumber, size, languageCode).enqueue(new Callback<com.tv.uscreen.bean_model_v1_0.listAll.likeList.Response>() {
                    @Override
                    public void onResponse(@NonNull Call<com.tv.uscreen.bean_model_v1_0.listAll.likeList.Response> call, @NonNull Response<com.tv.uscreen.bean_model_v1_0.listAll.likeList.Response> response) {
                        Gson gson = new Gson();
                        String json = gson.toJson(response.body());
                    ...
                    @Override
                    public void onFailure(@NonNull Call<com.tv.uscreen.bean_model_v1_0.listAll.likeList.Response> call, @NonNull Throwable t) {
...
//                            ArrayList<DataItem> enveuVideoDetails = (ArrayList<DataItem>) response.body().getData();
                    ...
                    try {
                        ...
                        for (int i = 0; i < dataSize; i++) {
                            ...
                            if (data != null && data.getItems() != null) {
                                railCommonData.setStatus(true);
                                List<com.tv.uscreen.beanModelV3.searchV2.ItemsItem> searchItems = data.getItems();
                                List<EnveuVideoItemBean> enveuVideoItemBeans = new ArrayList<>();
                                for (com.tv.uscreen.beanModelV3.searchV2.ItemsItem videoItem : searchItems) {
                            ...
                            if (data.isSuccessful()){
                                if (data.code() == 200) {
                                    ...
                                    if (data.body().getData() != null && data.body().getData().getItems() != null) {
                                        railCommonData.setStatus(true);
                                        List<com.tv.uscreen.beanModelV3.searchV2.ItemsItem> itemsItem = data.body().getData().getItems();
                                        enveuVideoItemBeans = new ArrayList<>();
                                        Gson gson = new Gson();
                                        String json = gson.toJson(itemsItem);
                                        Log.d("ENVUE", "onResponse: " + json);
                                        for (com.tv.uscreen.beanModelV3.searchV2.ItemsItem videoItem : itemsItem) {
                                            EnveuVideoItemBean enveuVideoItemBean = new EnveuVideoItemBean(videoItem);
                ...
                public void onResponse(@NonNull Call<ResponseSearch> call, @NonNull Response<ResponseSearch> response) {
                    if (response.code() == 200) {
                        ...
                        if (body != null) {
                            ...
                            if (data != null && data.getItems() != null) {
                                railCommonData.setStatus(true);
                                List<com.tv.uscreen.beanModelV3.searchV2.ItemsItem> itemsItem =
                                        data.getItems();
                                enveuVideoItemBeans = new ArrayList<>();
                                for (com.tv.uscreen.beanModelV3.searchV2.ItemsItem videoItem : itemsItem) {
                                    EnveuVideoItemBean enveuVideoItemBean = new EnveuVideoItemBean(videoItem);
    ...
    public void getRequestedOfferForUser(int page, int size, String token, int userId, String offers, String currentLanguageCode, RequestOfferCallBack requestOfferCallBack) {
        ...
        if (enveuSubscriptionEndPoint != null) {
            enveuSubscriptionEndPoint.getRequestOfferForUser(userId,offers,page,size,currentLanguageCode).enqueue(new Callback<com.tv.uscreen.bean_model_v1_0.listAll.RequestOfferList.Response>() {
                @Override
                public void onResponse(Call<com.tv.uscreen.bean_model_v1_0.listAll.RequestOfferList.Response> call, Response<com.tv.uscreen.bean_model_v1_0.listAll.RequestOfferList.Response> response) {
                    if (response.isSuccessful() && response.body()!=null && response.body().getData()!=null) {
                ...
                @Override
                public void onFailure(Call<com.tv.uscreen.bean_model_v1_0.listAll.RequestOfferList.Response> call, Throwable t) {
