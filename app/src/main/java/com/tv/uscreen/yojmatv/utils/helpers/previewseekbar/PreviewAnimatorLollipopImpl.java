...
package com.tv.uscreen.yojmatv.utils.helpers.previewseekbar;
...
class PreviewAnimatorLollipopImpl extends PreviewAnimator {
    ...
    static final int MORPH_REVEAL_DURATION = 0;
    ...
    private int getRadius(View view) {
        return (int) Math.hypot(view.getWidth() /(double) 2, view.getHeight() /(double) 2);
    }
