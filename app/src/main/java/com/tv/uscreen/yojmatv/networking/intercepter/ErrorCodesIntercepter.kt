package com.tv.uscreen.yojmatv.networking.intercepter
...
import com.tv.uscreen.yojmatv.redeemcoupon.RedeemCouponResponseModel
import com.tv.uscreen.yojmatv.repository.redeemCoupon.RedeemModel
...
class ErrorCodesIntercepter private constructor() {
    ...
    fun manualSignUp(response: Response<LoginResponseModel?>): SignupResponseAccessToken? {
        ...
        if (response.code() == ErrorCode409) {
            val cl = com.tv.uscreen.yojmatv.beanModel.responseModels.LoginResponse.LoginResponseModel()
    ...
    fun fbLogin(response: Response<LoginResponseModel?>): com.tv.uscreen.yojmatv.beanModel.responseModels.LoginResponse.LoginResponseModel? {
        var cl: com.tv.uscreen.yojmatv.beanModel.responseModels.LoginResponse.LoginResponseModel? = null
        try {
            cl = com.tv.uscreen.yojmatv.beanModel.responseModels.LoginResponse.LoginResponseModel()
            val errorObject = JSONObject(response.errorBody()!!.string())
            if (errorObject.getInt("responseCode") != 0) {
    ...
    fun Login(response: Response<LoginResponseModel?>): com.tv.uscreen.yojmatv.beanModel.responseModels.LoginResponse.LoginResponseModel? {
        var responseModel: com.tv.uscreen.yojmatv.beanModel.responseModels.LoginResponse.LoginResponseModel? = null
        try {
            responseModel = com.tv.uscreen.yojmatv.beanModel.responseModels.LoginResponse.LoginResponseModel()
            val errorObject = JSONObject(response.errorBody()!!.string())
    ...
    fun Auth(response: Response<AuthResponse?>): com.tv.uscreen.yojmatv.bean_model_v1_0.authResponse.AuthResponse? {
        var responseModel: com.tv.uscreen.yojmatv.bean_model_v1_0.authResponse.AuthResponse? = null
        try {
            responseModel = com.tv.uscreen.yojmatv.bean_model_v1_0.authResponse.AuthResponse()
            val errorObject = JSONObject(response.errorBody()!!.string())
            responseModel.responseCode = 400
            if (errorObject.getInt("responseCode") != 0) {
                if (errorObject.getInt("responseCode") != 0) {
    ...
    fun userProfile(response: Response<UserProfileResponse?>): com.tv.uscreen.yojmatv.beanModel.userProfile.UserProfileResponse {
        val empty = com.tv.uscreen.yojmatv.beanModel.userProfile.UserProfileResponse()
        try {
            val errorObject = JSONObject(response.errorBody()!!.string())
            if (errorObject.getInt("responseCode") != 0) {
                val code = errorObject.getInt("responseCode")
