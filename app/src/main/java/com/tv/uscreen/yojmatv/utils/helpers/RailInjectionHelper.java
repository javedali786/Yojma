...
import com.tv.uscreen.yojmatv.ObservableRxList;
...
import com.tv.uscreen.yojmatv.layersV2.ListPaginationDataLayer;
import com.tv.uscreen.yojmatv.layersV2.SearchLayer;
import com.tv.uscreen.yojmatv.layersV2.SeasonEpisodesList;
import com.tv.uscreen.yojmatv.layersV2.SeriesDataLayer;
import com.tv.uscreen.yojmatv.layersV2.VideoDetailLayer;
...
public class RailInjectionHelper extends AndroidViewModel {
    ...
    public LiveData<com.tv.uscreen.yojmatv.bean_model_v1_0.listAll.likeList.Response> getIsLikeGOI(String token, int pageNo, int size) {
        MutableLiveData<com.tv.uscreen.yojmatv.bean_model_v1_0.listAll.likeList.Response> liveData = new MutableLiveData();
         SeasonEpisodesList.getInstance().getIsLikeGOI(token, pageNo, size, new ApiLikeList() {
             @Override
             public void onSuccess(boolean isStatus, com.tv.uscreen.yojmatv.bean_model_v1_0.listAll.likeList.Response likeListResponse) {
