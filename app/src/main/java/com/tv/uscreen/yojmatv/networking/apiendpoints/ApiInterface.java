...
import com.tv.uscreen.yojmatv.beanModel.enveuCommonRailData.config.EnveuConfigResponse;
import com.tv.uscreen.yojmatv.beanModel.mobileAds.ResponseMobileAds;
import com.tv.uscreen.yojmatv.beanModel.popularSearch.ResponsePopularSearch;
...
import com.tv.uscreen.yojmatv.beanModel.responseModels.SignUp.SignUpResponseModel;
import com.tv.uscreen.yojmatv.beanModel.responseModels.landingTabResponses.playlistResponse.PlaylistResponses;
...
public interface ApiInterface {
    ...
    Call<com.tv.uscreen.yojmatv.bean_model_v1_0.listAll.likeList.Response> getIsLikeGOI(@Query("page") int pageNumber,
                                                                                        @Query("size") int pageSize,
                                                                                        @Query("locale") String locale);
