...
import static com.tv.uscreen.yojmatv.utils.constants.AppConstants.CAROUSEL_CST_CUSTOM;
import static com.tv.uscreen.yojmatv.utils.constants.AppConstants.CAROUSEL_LDS_BANNER;
import static com.tv.uscreen.yojmatv.utils.constants.AppConstants.CAROUSEL_LDS_LANDSCAPE;
import static com.tv.uscreen.yojmatv.utils.constants.AppConstants.CAROUSEL_PR_POSTER;
import static com.tv.uscreen.yojmatv.utils.constants.AppConstants.CAROUSEL_PR_POTRAIT;
import static com.tv.uscreen.yojmatv.utils.constants.AppConstants.CAROUSEL_SQR_SQUARE;
import static com.tv.uscreen.yojmatv.utils.constants.AppConstants.GRD_HORIZONTAL_CIR_CIRCLE;
import static com.tv.uscreen.yojmatv.utils.constants.AppConstants.GRD_HORIZONTAL_LDS_LANDSCAPE;
import static com.tv.uscreen.yojmatv.utils.constants.AppConstants.GRD_HORIZONTAL_PR_PORTRAIT;
import static com.tv.uscreen.yojmatv.utils.constants.AppConstants.GRD_HORIZONTAL_PR_POSTER;
import static com.tv.uscreen.yojmatv.utils.constants.AppConstants.GRD_HORIZONTAL_SQR_SQUARE;
import static com.tv.uscreen.yojmatv.utils.constants.AppConstants.HERO_CIR_CIRCLE;
import static com.tv.uscreen.yojmatv.utils.constants.AppConstants.HERO_CST_CUSTOM;
import static com.tv.uscreen.yojmatv.utils.constants.AppConstants.HERO_LDS_BANNER;
import static com.tv.uscreen.yojmatv.utils.constants.AppConstants.HERO_LDS_LANDSCAPE;
import static com.tv.uscreen.yojmatv.utils.constants.AppConstants.HERO_PR_POSTER;
import static com.tv.uscreen.yojmatv.utils.constants.AppConstants.HERO_PR_POTRAIT;
import static com.tv.uscreen.yojmatv.utils.constants.AppConstants.HERO_SQR_SQUARE;
import static com.tv.uscreen.yojmatv.utils.constants.AppConstants.HORIZONTAL_CIR_CIRCLE;
import static com.tv.uscreen.yojmatv.utils.constants.AppConstants.HORIZONTAL_LDS_LANDSCAPE;
import static com.tv.uscreen.yojmatv.utils.constants.AppConstants.HORIZONTAL_PR_POSTER;
import static com.tv.uscreen.yojmatv.utils.constants.AppConstants.HORIZONTAL_PR_POTRAIT;
import static com.tv.uscreen.yojmatv.utils.constants.AppConstants.HORIZONTAL_SQR_SQUARE;
...
import com.tv.uscreen.yojmatv.databinding.GridPosterPotraitRecyclerItemBinding;
import com.tv.uscreen.yojmatv.databinding.GridRecylerItemBinding;
import com.tv.uscreen.yojmatv.databinding.GridSquareRecyclerItemBinding;
import com.tv.uscreen.yojmatv.databinding.HeaderRecyclerItemBinding;
import com.tv.uscreen.yojmatv.databinding.HeadingRailsBinding;
import com.tv.uscreen.yojmatv.databinding.HeroAdsLayoutBinding;
...
import com.tv.uscreen.yojmatv.databinding.PotraitGridRecyclerItemBinding;
...
import com.tv.uscreen.yojmatv.utils.CustomLayoutManager;
            ...
            if (item.getScreenWidget().getEnableMultilingualTitle() != null && item.getScreenWidget().getEnableMultilingualTitle() instanceof Boolean) {
                ...
                if (isMultilingualTitleEnable) {
                    ...
                    if (KsPreferenceKeys.getInstance().getAppLanguage().equalsIgnoreCase("Spanish")) {
                        headingRailsBinding.headingTitle.setText(item.getScreenWidget().getName()+ " " + headingRailsBinding.headingTitle.getContext().getResources().getString(R.string.For) + " " + KsPreferenceKeys.getInstance().getAppPrefUserName());
                    } else {
