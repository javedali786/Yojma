package com.tv.uscreen.utils.helpers.carousel
...
import com.tv.uscreen.utils.commonMethods.AppCommonMethod.Companion.convertDpToPixel
import com.tv.uscreen.utils.constants.AppConstants
import com.tv.uscreen.utils.helpers.carousel.adapter.SliderAdapter
import com.tv.uscreen.utils.helpers.carousel.indicators.IndicatorShape
import com.tv.uscreen.utils.helpers.carousel.indicators.SlideIndicatorsGroup
...
class Slider : FrameLayout, OnPageChangeListener {
    ...
    fun addSlides(
        ...
        if (!hideIndicators && slideCount > 1) {
            ...
            slideIndicatorsGroup!!.changeIndicator(
                ColorsHelper.strokeBgDrawable(AppColors.selectedIndicatorColor(), AppColors.selectedIndicatorColor() , 200f),
