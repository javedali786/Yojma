...
import com.tv.uscreen.ObservableRxList;
...
import com.tv.uscreen.layersV2.ContinueWatchingLayer;
import com.tv.uscreen.layersV2.ListPaginationDataLayer;
import com.tv.uscreen.layersV2.SearchLayer;
import com.tv.uscreen.layersV2.SeasonEpisodesList;
import com.tv.uscreen.layersV2.SeriesDataLayer;
import com.tv.uscreen.layersV2.VideoDetailLayer;
...
public class RailInjectionHelper extends AndroidViewModel {
    ...
    public LiveData<com.tv.uscreen.bean_model_v1_0.listAll.likeList.Response> getIsLikeGOI(String token, int pageNo, int size) {
        MutableLiveData<com.tv.uscreen.bean_model_v1_0.listAll.likeList.Response> liveData = new MutableLiveData();
         SeasonEpisodesList.getInstance().getIsLikeGOI(token, pageNo, size, new ApiLikeList() {
             @Override
             public void onSuccess(boolean isStatus, com.tv.uscreen.bean_model_v1_0.listAll.likeList.Response likeListResponse) {
