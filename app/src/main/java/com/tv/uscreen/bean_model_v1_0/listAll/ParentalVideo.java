...
package com.tv.uscreen.bean_model_v1_0.listAll;
...
public class ParentalVideo implements Serializable
{
    ...
    @Expose
    private List<ParentalImage> images = null;
    public final static Parcelable.Creator<ParentalVideo> CREATOR = new Parcelable.Creator<ParentalVideo>() {

        @SuppressWarnings({
            "unchecked"
        })
        public ParentalVideo createFromParcel(android.os.Parcel in) {
            return new ParentalVideo(in);
        }

        public ParentalVideo[] newArray(int size) {
            return (new ParentalVideo[size]);
        }

    }
    ;

    protected ParentalVideo(android.os.Parcel in) {
        ...
        in.readList(this.images, (ParentalImage.class.getClassLoader()));
    }

    public ParentalVideo() {
    }
    ...
    public List<ParentalImage> getImages() {
        return images;
    }

    public void setImages(List<ParentalImage> images) {
        this.images = images;
    }
