...
import com.tv.uscreen.beanModelV3.playListModelV2.NewImages;
...
public class VideoItem implements Parcelable
{
    ...
    public final static Creator<VideoItem> CREATOR = new Creator<VideoItem>() {


        @SuppressWarnings({
                "unchecked"
        })
        public VideoItem createFromParcel(android.os.Parcel in) {
    ...
    protected VideoItem(android.os.Parcel in) {
