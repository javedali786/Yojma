...
public class DetailVideoImage implements Serializable
{
    ...
    public final static Parcelable.Creator<DetailVideoImage> CREATOR = new Parcelable.Creator<DetailVideoImage>() {


        @SuppressWarnings({
            "unchecked"
        })
        public DetailVideoImage createFromParcel(android.os.Parcel in) {
            return new DetailVideoImage(in);
        }

        public DetailVideoImage[] newArray(int size) {
            return (new DetailVideoImage[size]);
        }

    }
    ;

    protected DetailVideoImage(android.os.Parcel in) {
