package com.tv.activities.watchList.ui
...
import com.tv.activities.listing.listadapter.ListAdapter
import com.tv.activities.series.ui.SeriesDetailActivity
import com.tv.activities.watchList.adapter.WatchHistoryAdapter
import com.tv.activities.watchList.adapter.WatchHistoryAdapter.WatchHistoryAdaperListener
import com.tv.activities.watchList.adapter.WatchListAdapter
import com.tv.activities.watchList.adapter.WatchListAdapter.DeleteWatchList
import com.tv.activities.watchList.adapter.WatchListAdapter.WatchListAdaperListener
import com.tv.activities.watchList.viewModel.WatchListViewModel
import com.tv.adapters.CommonShimmerAdapter
import com.tv.baseModels.BaseBindingActivity
import com.tv.beanModel.allWatchList.ItemsItem
...
import com.tv.databinding.WatchListActivityBinding
import com.tv.fragments.dialog.AlertDialogFragment
import com.tv.fragments.dialog.AlertDialogSingleButtonFragment
...
import com.tv.utils.helpers.RailInjectionHelper
...
class WatchListActivity : BaseBindingActivity<WatchListActivityBinding?>(), WatchListAdaperListener, WatchHistoryAdaperListener, DeleteWatchList, AlertDialogFragment.AlertDialogListener,
    ...
    private var itemValue: ItemsItem? = null
    ...
    override fun onWatchHistoryItemClicked(itemValue: com.tv.beanModel.watchHistory.ItemsItem) {
    ...
    override fun onWatchListItemClicked(itemValue: ItemsItem) {
        if (SystemClock.elapsedRealtime() - mLastClickTime < 1200) {
            return
        }
        mLastClickTime = SystemClock.elapsedRealtime()
    ...
    override fun onDeleteClick(itemValue: ItemsItem) {
        try {
            deleteItem = true
            isloggedout = false
