package com.tv.activities.splash.ui
...
import com.tv.activities.purchase.in_app_billing.InAppProcessListener
import com.tv.activities.purchase.in_app_billing.RestoreSubscriptionCallback
import com.tv.activities.purchase.plans_layer.GetPlansLayer
import com.tv.activities.splash.dialog.ConfigFailDialog
...
import com.tv.callbacks.commonCallbacks.DialogInterface
import com.tv.callbacks.commonCallbacks.VersionUpdateCallBack
import com.tv.callbacks.commonCallbacks.VersionValidator
import com.tv.databinding.ActivitySplashBinding
import com.tv.dependencies.providers.DTGPrefrencesProvider
...
import com.tv.utils.config.ConfigManager
import com.tv.utils.config.bean.dmsResponse.ConfigBean
import com.tv.utils.constants.AppConstants
import com.tv.utils.helpers.AnalyticsController
import com.tv.utils.helpers.ForceUpdateHandler
import com.tv.utils.helpers.NetworkConnectivity
import com.tv.utils.helpers.SharedPrefHelper
