...
public class DownloadProgressBar extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            backgroundStrokeWidth = typedArray.getDimension(R.styleable.CircularProgressBar_progressbar_width, strokeWidth);
            // Color
     ...
     * so don't call the {@link DownloadProgressBar#setProgress(float)} directly within this method.
     *
