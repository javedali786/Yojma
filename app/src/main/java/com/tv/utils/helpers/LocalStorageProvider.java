...
//        // row.add(Root.COLUMN_ICON, R.mipmap.ic_provider);
...
//        } catch (IOException e) {
//            Logger.e(LocalStorageProvider.class.getSimpleName(), "Error creating new file " + newFile);
//        }
        return null;
    }
    ...
    public AssetFileDescriptor openDocumentThumbnail(final String documentId, final Point sizeHint,
        ...
        try {
            tempFile = File.createTempFile("thumbnail", null, Objects.requireNonNull(getContext()).getCacheDir());
            out = new FileOutputStream(tempFile);
            bitmap.compress(Bitmap.CompressFormat.PNG, 90, out);
        } catch (IOException e) {
            Logger.e(LocalStorageProvider.class.getSimpleName(), "Error writing thumbnail"+ e);
            return null;
        } finally {
            if (out != null)
                try {
                    ...
                    Logger.e(LocalStorageProvider.class.getSimpleName(), "Error closing thumbnail"+ e);
                }
        }
