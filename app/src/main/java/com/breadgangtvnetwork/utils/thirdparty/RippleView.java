package com.breadgangtvnetwork.utils.thirdparty;
...
public class RippleView extends RelativeLayout {
    ...
    private void init(final Context context, final AttributeSet attrs) {
        ...
        rippleColor = typedArray.getColor(R.styleable.RippleView_rv_color, getResources().getColor(R.color.series_detail_all_episode_txt_color));
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        scaleAnimation = new ScaleAnimation(1.0f, zoomScale, 1.0f, zoomScale, w /(float) 2, h /(float) 2);
    ...
    private void createAnimation(final float x, final float y) {
        if (this.isEnabled() && !animationRunning) {
            ...
            if (isCentered || rippleType == 1) {
                this.x = getMeasuredWidth() /(float) 2;
                this.y = getMeasuredHeight() / (float)2;
            } else {
                this.x = x;
                this.y = y;
            }
