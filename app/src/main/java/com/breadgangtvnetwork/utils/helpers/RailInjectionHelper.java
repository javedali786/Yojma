...
import com.breadgangtvnetwork.ObservableRxList;
...
import com.breadgangtvnetwork.layersV2.ContinueWatchingLayer;
import com.breadgangtvnetwork.layersV2.ListPaginationDataLayer;
import com.breadgangtvnetwork.layersV2.SearchLayer;
import com.breadgangtvnetwork.layersV2.SeasonEpisodesList;
import com.breadgangtvnetwork.layersV2.SeriesDataLayer;
...
public class RailInjectionHelper extends AndroidViewModel {
    ...
    public LiveData<com.breadgangtvnetwork.bean_model_v1_0.listAll.likeList.Response> getIsLikeGOI(String token, int pageNo, int size) {
        MutableLiveData<com.breadgangtvnetwork.bean_model_v1_0.listAll.likeList.Response> liveData = new MutableLiveData();
         SeasonEpisodesList.getInstance().getIsLikeGOI(token, pageNo, size, new ApiLikeList() {
             @Override
             public void onSuccess(boolean isStatus, com.breadgangtvnetwork.bean_model_v1_0.listAll.likeList.Response likeListResponse) {
