...
object AppColors {
    ...
    fun termsAndConditionTextColor(): Int = ColorsHelper.colorParser(ColorsHelper.instance()?.data?.config?.signup_terms_and_condition_text_color.toString(), R.color.signup_terms_and_condition_text_color)
    ...
    fun detailPageTabItemUnselectedTxtColor(): Int = ColorsHelper.colorParser(ColorsHelper.instance()?.data?.config?.series_detail_tab_item_unselected_txt_color.toString(), R.color.series_detail_tab_item_unselected_txt_color)
    fun detailPageTabItemSelectedTxtColor(): Int = ColorsHelper.colorParser(ColorsHelper.instance()?.data?.config?.series_detail_tab_item_selected_txt_color.toString(), R.color.series_detail_tab_item_selected_txt_color)
    fun detailPageTabUnselectedBorderColor(): Int = ColorsHelper.colorParser(ColorsHelper.instance()?.data?.config?.series_detail_tab_unselected_border_color.toString(), R.color.series_detail_tab_unselected_border_color)
    fun detailPageTabSelectedBorderColor(): Int = ColorsHelper.colorParser(ColorsHelper.instance()?.data?.config?.series_detail_tab_selected_bg_color.toString(), R.color.series_detail_tab_selected_bg_color)
    ...
    fun detailPageLikeUnselectedColor(): Int = ColorsHelper.colorParser(ColorsHelper.instance()?.data?.config?.series_detail_like_unselected_color.toString(), R.color.series_detail_like_unselected_color)
    fun detailPageMyListSelectedColor(): Int = ColorsHelper.colorParser(ColorsHelper.instance()?.data?.config?.series_detail_my_list_selected_color.toString(), R.color.series_detail_my_list_selected_color)
    fun detailPageMyListUnselectedColor(): Int = ColorsHelper.colorParser(ColorsHelper.instance()?.data?.config?.series_detail_my_list_unselected_color.toString(), R.color.series_detail_my_list_unselected_color)
