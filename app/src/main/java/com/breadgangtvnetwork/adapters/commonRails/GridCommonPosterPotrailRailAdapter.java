...
import com.breadgangtvnetwork.databinding.GridPosterPotraitItemBinding;
import com.breadgangtvnetwork.databinding.PosterPotraitItemLargeBinding;
import com.breadgangtvnetwork.databinding.PosterPotraitItemSmallBinding;
...
public class GridCommonPosterPotrailRailAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public GridCommonPosterPotrailRailAdapter(RailCommonData railCommonData, int position, CommonRailtItemClickListner listner, BaseCategory baseCat) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        if (baseCategory!=null && baseCategory.getRailCardSize()!=null){
            if (baseCategory.getRailCardSize().equalsIgnoreCase(RailCardSize.NORMAL.name())){
                GridPosterPotraitItemBinding binding = DataBindingUtil.inflate(
                        LayoutInflater.from(parent.getContext()),
                        R.layout.grid_poster_potrait_item, parent, false);
    ...
    private void setNomalValues(GridPosterPotraitItemBinding itemBinding,int i) {
        itemBinding.setPlaylistItem(videos.get(i));
        itemBinding.rippleView.setOnClickListener(v -> {
            itemClick(i);
    ...
    public class NormalHolder extends RecyclerView.ViewHolder {
        ...
        final GridPosterPotraitItemBinding circularItemBinding;

        NormalHolder(GridPosterPotraitItemBinding circularItemBind) {
