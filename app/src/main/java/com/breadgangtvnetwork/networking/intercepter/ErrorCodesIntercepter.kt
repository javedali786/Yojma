package com.breadgangtvnetwork.networking.intercepter
...
import com.breadgangtvnetwork.activities.usermanagment.model.OtpResponse
...
import com.breadgangtvnetwork.beanModel.responseGetWatchlist.ResponseGetIsWatchlist
import com.breadgangtvnetwork.beanModel.responseIsLike.ResponseIsLike
import com.breadgangtvnetwork.beanModel.responseModels.SignUp.SignupResponseAccessToken
import com.breadgangtvnetwork.beanModel.responseModels.listAllAccounts.AllSecondaryAccountDetails
import com.breadgangtvnetwork.beanModel.responseModels.secondaryUserDetails.SecondaryUserDetailsJavaPojo
import com.breadgangtvnetwork.beanModel.responseModels.switchUserDetail.SwitchUser
import com.breadgangtvnetwork.redeemcoupon.RedeemCouponResponseModel
import com.breadgangtvnetwork.repository.redeemCoupon.RedeemModel
...
class ErrorCodesIntercepter private constructor() {
    ...
    fun manualSignUp(response: Response<LoginResponseModel?>): SignupResponseAccessToken? {
        ...
        if (response.code() == ErrorCode409) {
            val cl = com.breadgangtvnetwork.beanModel.responseModels.LoginResponse.LoginResponseModel()
    ...
    fun fbLogin(response: Response<LoginResponseModel?>): com.breadgangtvnetwork.beanModel.responseModels.LoginResponse.LoginResponseModel? {
        var cl: com.breadgangtvnetwork.beanModel.responseModels.LoginResponse.LoginResponseModel? = null
        try {
            cl = com.breadgangtvnetwork.beanModel.responseModels.LoginResponse.LoginResponseModel()
            val errorObject = JSONObject(response.errorBody()!!.string())
            if (errorObject.getInt("responseCode") != 0) {
    ...
    fun Login(response: Response<LoginResponseModel?>): com.breadgangtvnetwork.beanModel.responseModels.LoginResponse.LoginResponseModel? {
        var responseModel: com.breadgangtvnetwork.beanModel.responseModels.LoginResponse.LoginResponseModel? = null
        try {
            responseModel = com.breadgangtvnetwork.beanModel.responseModels.LoginResponse.LoginResponseModel()
            val errorObject = JSONObject(response.errorBody()!!.string())
    ...
    fun Auth(response: Response<AuthResponse?>): com.breadgangtvnetwork.bean_model_v1_0.authResponse.AuthResponse? {
        var responseModel: com.breadgangtvnetwork.bean_model_v1_0.authResponse.AuthResponse? = null
        try {
            responseModel = com.breadgangtvnetwork.bean_model_v1_0.authResponse.AuthResponse()
            val errorObject = JSONObject(response.errorBody()!!.string())
            responseModel.responseCode = 400
            if (errorObject.getInt("responseCode") != 0) {
                if (errorObject.getInt("responseCode") != 0) {
    ...
    fun userProfile(response: Response<UserProfileResponse?>): com.breadgangtvnetwork.beanModel.userProfile.UserProfileResponse {
        val empty = com.breadgangtvnetwork.beanModel.userProfile.UserProfileResponse()
        try {
            val errorObject = JSONObject(response.errorBody()!!.string())
            if (errorObject.getInt("responseCode") != 0) {
                val code = errorObject.getInt("responseCode")
