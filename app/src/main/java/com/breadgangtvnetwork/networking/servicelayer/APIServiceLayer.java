package com.breadgangtvnetwork.networking.servicelayer;
...
import com.breadgangtvnetwork.activities.watchList.model.VideoIdModel;
...
import com.breadgangtvnetwork.beanModelV3.continueWatching.ContinueWatchingModel;
import com.breadgangtvnetwork.beanModelV3.continueWatching.DataItem;
import com.breadgangtvnetwork.beanModelV3.playListModelV2.EnveuCommonResponse;
import com.breadgangtvnetwork.beanModelV3.searchV2.Data;
import com.breadgangtvnetwork.beanModelV3.searchV2.ResponseSearch;
...
import com.breadgangtvnetwork.bean_model_v1_0.listAll.ListAllContent;
import com.breadgangtvnetwork.bean_model_v1_0.videoDetailBean.EnvVideoDetailsBean;
import com.breadgangtvnetwork.callbacks.RequestOffferCallBack.RequestOfferCallBack;
...
import com.breadgangtvnetwork.callbacks.likelistCallback.ApiLikeList;
...
public class APIServiceLayer {
    ...
    public void getIsLikeGOI(String token ,int pageNumber, int size, ApiLikeList listener) {
        ...
        if (enveuSubscriptionEndPoint!=null) {
            enveuSubscriptionEndPoint.getIsLikeGOI(pageNumber, size, languageCode).enqueue(new Callback<com.breadgangtvnetwork.bean_model_v1_0.listAll.likeList.Response>() {
                    @Override
                    public void onResponse(@NonNull Call<com.breadgangtvnetwork.bean_model_v1_0.listAll.likeList.Response> call, @NonNull Response<com.breadgangtvnetwork.bean_model_v1_0.listAll.likeList.Response> response) {
                        Gson gson = new Gson();
                        String json = gson.toJson(response.body());
                    ...
                    @Override
                    public void onFailure(@NonNull Call<com.breadgangtvnetwork.bean_model_v1_0.listAll.likeList.Response> call, @NonNull Throwable t) {
...
//                            ArrayList<DataItem> enveuVideoDetails = (ArrayList<DataItem>) response.body().getData();
                    ...
                    try {
                        ...
                        for (int i = 0; i < dataSize; i++) {
                            ...
                            if (data != null && data.getItems() != null) {
                                railCommonData.setStatus(true);
                                List<com.breadgangtvnetwork.beanModelV3.searchV2.ItemsItem> searchItems = data.getItems();
                                List<EnveuVideoItemBean> enveuVideoItemBeans = new ArrayList<>();
                                for (com.breadgangtvnetwork.beanModelV3.searchV2.ItemsItem videoItem : searchItems) {
                            ...
                            if (data.isSuccessful()){
                                if (data.code() == 200) {
                                    ...
                                    if (data.body().getData() != null && data.body().getData().getItems() != null) {
                                        railCommonData.setStatus(true);
                                        List<com.breadgangtvnetwork.beanModelV3.searchV2.ItemsItem> itemsItem = data.body().getData().getItems();
                                        enveuVideoItemBeans = new ArrayList<>();
                                        Gson gson = new Gson();
                                        String json = gson.toJson(itemsItem);
                                        Log.d("ENVUE", "onResponse: " + json);
                                        for (com.breadgangtvnetwork.beanModelV3.searchV2.ItemsItem videoItem : itemsItem) {
                                            EnveuVideoItemBean enveuVideoItemBean = new EnveuVideoItemBean(videoItem);
                ...
                public void onResponse(@NonNull Call<ResponseSearch> call, @NonNull Response<ResponseSearch> response) {
                    if (response.code() == 200) {
                        ...
                        if (body != null) {
                            ...
                            if (data != null && data.getItems() != null) {
                                railCommonData.setStatus(true);
                                List<com.breadgangtvnetwork.beanModelV3.searchV2.ItemsItem> itemsItem =
                                        data.getItems();
                                enveuVideoItemBeans = new ArrayList<>();
                                for (com.breadgangtvnetwork.beanModelV3.searchV2.ItemsItem videoItem : itemsItem) {
                                    EnveuVideoItemBean enveuVideoItemBean = new EnveuVideoItemBean(videoItem);
    ...
    public void getRequestedOfferForUser(int page, int size, String token, int userId, String offers, String currentLanguageCode, RequestOfferCallBack requestOfferCallBack) {
        ...
        if (enveuSubscriptionEndPoint != null) {
            enveuSubscriptionEndPoint.getRequestOfferForUser(userId,offers,page,size,currentLanguageCode).enqueue(new Callback<com.breadgangtvnetwork.bean_model_v1_0.listAll.RequestOfferList.Response>() {
                @Override
                public void onResponse(Call<com.breadgangtvnetwork.bean_model_v1_0.listAll.RequestOfferList.Response> call, Response<com.breadgangtvnetwork.bean_model_v1_0.listAll.RequestOfferList.Response> response) {
                    if (response.isSuccessful() && response.body()!=null && response.body().getData()!=null) {
                ...
                @Override
                public void onFailure(Call<com.breadgangtvnetwork.bean_model_v1_0.listAll.RequestOfferList.Response> call, Throwable t) {
